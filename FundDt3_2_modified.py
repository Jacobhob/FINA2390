...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  1 10:12:31 2017
...
for i in range(6000,7000,50):
  ...
  #      print(data)
        ...
        print('offset',i,'completed')
        fundlist.extend(fund["result"])
    except:
        print('cannot get data with offset' + str(i))
        break
...
with open("out_7.csv", "w") as f:
    writer = csv.DictWriter(f, fieldnames=headers, extrasaction='ignore')
    writer.writeheader()
    for fund in fundlist:
        try:
#            row = {i: fund[i].encode('utf-8') for i in headers}
